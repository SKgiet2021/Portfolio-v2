...
const GlowingEffect = memo(
  ({
    ...
    // Auto-cycle animation for mobile or when requested
    useEffect(() => {
      // If mobile, force continuous cycle
      if (isMobile) {
        const element = containerRef.current;
        if (!element) return;

        // Force active state for auto-cycle
