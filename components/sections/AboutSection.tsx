          ...
          >
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-sm text-muted-foreground leading-relaxed">
                <p>
                  B.Tech CS graduate specializing in Data Science. Experience at{" "}
                  <span className="text-primary font-medium">Wipro</span>,{" "}
                  <span className="text-primary font-medium">Salesforce</span>,
                  and{" "}
                ...
                <p>
                  ...
                  <span className="font-medium text-foreground">
                    Python, React, Django, .NET, ML
                  </span>
                  . Building innovative solutions bridging development and data
                  science.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              <a
                ...
                className="px-3 py-1.5 rounded-lg border border-border bg-background/50 hover:border-primary/50 transition-colors text-xs font-medium"
              >
                GitHub
              </a>
              <a
